...
const Messager = require('ursys/common/class-messager');
const CENTRAL = require('ursys/chrome/ur-central').default;
const URNET = require('ursys/chrome/ur-network').default; // workaround for require
const DATAMAP = require('ursys/common/class-datamap');
