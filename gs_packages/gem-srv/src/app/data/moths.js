...
when Predator centerTouchesCenter Moth [[
  ...
  every 2 [[
    ...
    featCall Moth.Costume setCostume 'dead_moth.json' 0
    featCall Predator.Costume setGlow 1
...
# PROGRAM DEFINE
useFeature Costume
featCall Costume setCostume 'tree_trunk.json' 0
...
# PROGRAM DEFINE
useFeature Costume
featCall Costume setCostume 'tree_leaves.json' 0
...
featProp Physics scale setTo 0.5
featProp Physics scaleY setTo 1.0`
    },
    {
      id: 1201,
      name: 'Moth1',
