/*///////////////////////////////// ABOUT \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\*\
  ...
  implementation of keyword "onTick" command object
...
/// CLASS DEFINITION //////////////////////////////////////////////////////////
/// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
export class onTick extends Keyword {
  // base properties defined in KeywordDef

  constructor() {
    super('onTick');
    this.args = ['termA', 'termB'];
  }
  /* NOTE THIS IS NONFUNCTIONAL */
  /** create smc blueprint code objects */
  compile(unit: TScriptUnit): ISMCBundle {
    const [kw, termA, termB] = unit;
    console.log('onTick A:', termA, 'B:', termB);
    const cout = [];
    cout.push();
    return {
      define: [],
