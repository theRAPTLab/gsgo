...
script = [
  [{ 'directive': '#' }, { 'token': 'BLUEPRINT' }, { 'token': 'Moth' }],
  [{ 'directive': '#' }, { 'token': 'PROGRAM' }, { 'token': 'DEFINE' }],
  [{ 'token': 'useFeature' }, { 'token': 'Costume' }],
  [
    { 'token': 'featCall' },
  ...
  [
    { 'token': 'featProp' },
    { 'token': 'Costume' },
    { 'token': 'colorScaleIndex' },
    { 'token': 'setTo' },
    { 'value': 9 }
  ],
  [{ 'comment': 'blank' }],
  [{ 'comment': 'Fully visible' }],
  [
    { 'token': 'prop' },
    { 'token': 'alpha' },
    { 'token': 'setTo' },
  ...
  [{ 'comment': 'featCall Movement wanderUntilInside TreeFoliage' }],
  [{ 'comment': 'blank' }],
  [{ 'token': 'useFeature' }, { 'token': 'Physics' }],
  [
    { 'token': 'featProp' },
    { 'token': 'Physics' },
    { 'token': 'scale' },
  ...
  [{ 'comment': 'blank' }],
  [{ 'token': 'useFeature' }, { 'token': 'Touches' }],
  [
    { 'token': 'featCall' },
    { 'token': 'Touches' },
    { 'token': 'monitor' },
  ...
  [{ 'comment': 'blank' }],
  [{ 'comment': 'allow removal by  Predator' }],
  [{ 'comment': 'allow spawning' }],
  [{ 'token': 'useFeature' }, { 'token': 'Population' }],
  [{ 'comment': 'blank' }],
  [{ 'comment': 'allow Predator to see us' }],
  [{ 'token': 'useFeature' }, { 'token': 'Vision' }],
  [{ 'comment': 'blank' }],
  [
    { 'token': 'addProp' },
    { 'token': 'energyLevel' },
  ...
  [{ 'comment': 'blank' }],
  [{ 'token': 'useFeature' }, { 'token': 'AgentWidgets' }],
  [
    { 'token': 'featCall' },
    { 'token': 'AgentWidgets' },
    { 'token': 'bindMeterTo' },
  ...
  [{ 'comment': 'blank' }],
  [{ 'comment': '// random color: shift hue and value' }],
  [{ 'comment': 'featCall Costume randomizeColorHSV 0.1 0 0.2' }],
  [{ 'comment': 'blank' }],
  [{ 'comment': 'random start position' }],
  [{ 'comment': 'featCall Movement setRandomStart' }],
  [{ 'comment': 'blank' }],
  [{ 'comment': 'allow access to global darkMoths/lightMoths values' }],
  [{ 'token': 'useFeature' }, { 'token': 'Global' }],
  [{ 'comment': 'blank' }],
  [{ 'token': 'useFeature' }, { 'token': 'Cursor' }],
  [{ 'comment': 'blank' }],
  [{ 'directive': '#' }, { 'token': 'PROGRAM' }, { 'token': 'INIT' }],
  [{ 'comment': "Don't randomize here or we'll keep getting new colors" }],
  [{ 'comment': 'Set randomize in # PROGRAM DEFINE' }],
  [{ 'comment': 'featCall Costume randomizeColorHSV 0.1 0 0.2' }],
  [{ 'comment': 'featCall Movement setRandomStart' }],
  [{ 'comment': 'blank' }],
  [{ 'directive': '#' }, { 'token': 'PROGRAM' }, { 'token': 'UPDATE' }],
  ...
  [
    ...
    { 'value': 1 },
    [
      [[{ 'comment': 'Blink every second if invisible' }]],
      [
        { 'token': 'ifExpr' },
        { 'expr': '!agent.prop.Vision.visionable.value' },
        [
          [
            { 'token': 'featCall' },
            { 'token': 'Costume' },
  ...
  [
    ...
    [
      [
        ...
        {
          'expr':
            "Moth.callFeatMethod('Costume', 'colorHSVWithinRange', Moth.prop.color.value, TreeTrunk.prop.color.value, 0.2, 1, 0.2)"
        },
        [
          [
            [
              {
                'comment': 'color matches trunk, fade away and set un-visionable'
              }
            ]
          ],
          [
      ...
      [
        { 'token': 'ifExpr' },
        { 'expr': '!Moth.prop.isInert.value' },
        [
          [[{ 'comment': 'show wings folded pose' }]],
          [
            { 'token': 'featCall' },
            { 'objref': ['Moth', 'Costume'] },
            { 'token': 'setPose' },
      ...
      [
        ...
        [
          [
            { 'token': 'ifExpr' },
            {
              'expr': "agent.getProp('energyLevel').value > 90 && !agent.isInert"
            },
            [
              [[{ 'comment': "dbgOut 'SPAWN!'" }]],
              [
                { 'token': 'featCall' },
                { 'token': 'Population' },
                { 'token': 'spawnChild' },
                [
                  [[{ 'comment': 'new spawn init script (not current agent)' }]],
                  [[{ 'comment': 'spawn randomly darker' }]],
                  [
                    { 'token': 'featProp' },
                    { 'token': 'Costume' },
                    { 'token': 'colorValue' },
                  ...
                  [],
                  [[{ 'comment': 'add point to global graphs' }]],
                  [
                    { 'token': 'ifExpr' },
                    { 'expr': 'agent.prop.Costume.colorValue.value < 0.5' },
                    [
                      [
                        { 'token': 'featCall' },
                        { 'token': 'Global' },
  ...
  [
    ...
    [
      [
        ...
        {
          'expr':
            "Moth.callFeatMethod('Costume', 'colorHSVWithinRange', Moth.prop.color.value, TreeFoliage.prop.color.value, 0.2, 1, 0.2)"
        },
        [
          [[{ 'comment': 'color matches, fade away and set un-visionable' }]],
          [
            { 'token': 'prop' },
            { 'token': 'alpha' },
            { 'token': 'setMin' },
      ...
      [
        ...
        { 'expr': '!Moth.prop.isInert.value' },
        [
          [[{ 'comment': 'show wings folded pose (when not inert)' }]],
          [
            { 'token': 'featCall' },
            { 'objref': ['Moth', 'Costume'] },
            { 'token': 'setPose' },
      ...
      [
        { 'token': 'ifExpr' },
        { 'expr': 'Moth.prop.energyLevel.value < 60' },
        [
          [[{ 'comment': 'go search for new tree if energyLevel is low' }]],
          [[{ 'comment': 'featCall Moth.Movement setMovementType wander' }]]
        ]
      ]
    ]
  ],
  [
    ...
    [
      [
        [{ 'comment': 'seek foliage again after you wander off the old foliage' }]
      ],
      [[{ 'comment': 'featCall Moth.Movement wanderUntilInside TreeFoliage' }]]
    ]
  ],
  [{ 'comment': 'overide all' }],
  [
    { 'token': 'ifExpr' },
    { 'expr': "agent.getFeatProp('Movement', 'isMoving').value" },
    [
      [[{ 'comment': 'visible when moving' }]],
      [
        { 'token': 'prop' },
        { 'token': 'alpha' },
        { 'token': 'setMin' },
  ...
  [
    { 'token': 'ifExpr' },
    { 'expr': "agent.getProp('isInert').value" },
    [
      [[{ 'comment': 'always faded if inert' }]],
      [
        { 'token': 'prop' },
        { 'token': 'alpha' },
        { 'token': 'setMin' },
...
`,
  expect:
    '[[[{"token":"ifExpr"},{"expr":"A"},[[[{"comment":"comment A"}]],[{"token":"prop"},{"token":"A"},{"token":"setTo"},{"value":1}],[{"token":"ifExpr"},{"expr":"B"},[[[{"comment":"comment B"}]],[{"token":"prop"},{"token":"B"},{"token":"setTo"},{"value":2}]]]]]]]'
};
script = [
  [
    { 'token': 'ifExpr' },
